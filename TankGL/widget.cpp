...
int Widget::loadGLTextures()            // Load Bitmaps And Convert To Textures
{
    ...
    QImage* image2 = new QImage("ba.bmp");
    ...
    gluBuild2DMipmaps(GL_TEXTURE_2D, 3, image2->size().width(),
                      image2->size().height(),
                      GL_BGRA_EXT, GL_UNSIGNED_BYTE, data2);
    ...
    gluBuild2DMipmaps(GL_TEXTURE_2D, 3, image3->size().width(),
                      image3->size().height(),
                      GL_BGRA_EXT, GL_UNSIGNED_BYTE, data3);

    QImage* image4 = new QImage("pa.bmp");
    ...
    QImage* image5 = new QImage("pa.bmp");
    ...
    gluBuild2DMipmaps(GL_TEXTURE_2D, 3, image5->size().width(),
                      image5->size().height(),
                      GL_BGRA_EXT, GL_UNSIGNED_BYTE, data5);
